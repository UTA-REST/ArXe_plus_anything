# This is used so that the .h5 data can be used to compare the Outputs of PyBoltz. 
...
setup(
    ...
    name='ArXe_plus_anythin',  # Required
    ...
    install_requires=['tables, numpy, matplotlib'],  # Optional
